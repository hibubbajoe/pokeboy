        ...
        gameObjects: {
            ...
            npc2: new Person({
                ...
                talking: [
                    {
                        events: [
                            { type: "textMessage", text: "You can't come in here..", faceHero: "npc2" },
                        ]
                    }
                ]
            }),
            npc3: new Person({
                ...
                talking: [
                    {
                        events: [
                            { type: "textMessage", text: "I kinda wanna go swim man!", faceHero: "npc3" },
                        ]
                    }
                ]
            }),
            npc4: new Person({
                ...
                talking: [
                    {
                        events: [
                            { type: "textMessage", text: "BOO!!", faceHero: "npc3" },
                        ]
                    }
                ]
            })
        ...
        gameObjects: {
            ...
            npc1: new Person({
                ...
                talking: [
                    {
                        events: [
                            { type: "textMessage", text: "I smell like beef!", faceHero: "npc1" },
                        ]
                    }
                ],
            })
